...
#Examine Dataset
Hourly_Data %>% group_by(weathersit) %>% summarise(total = n()) %>% ggplot(aes(weathersit, total)) + geom_line()
Hourly_Data %>% group_by(atemp) %>% summarise(total = n()) %>% ggplot(aes(atemp, total)) + geom_line()
Hourly_Data %>% group_by(weekday) %>% summarise(total = n()) %>% ggplot(aes(weekday, total)) + geom_line()
Hourly_Data %>% group_by(workingday) %>% summarise(total = n()) %>% ggplot(aes(workingday,total)) + geom_col()
Hourly_Data %>% group_by(holiday) %>% summarise(total = n()) %>% ggplot(aes(holiday, total)) + geom_col()
...
#plot the output
importance %>% ggplot(aes(importance)) + geom_line()
